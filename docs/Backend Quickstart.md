# Developer Quickstart Guide - Talkspace
This **README** file provides a step-by-step guide for setting up the development environment for developers and contributors who intend to join in the development of talkspace.
<hr>
...
$ git clone https://github.com/edwardpeter547/talkspace.git
```
a folder **talkspace** should exist in your local directory
...
To create a Talkspace superuser for admin access, run:
```
sh
